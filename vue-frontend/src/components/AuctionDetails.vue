    ...
    export default {
       ...
       created() {
            this.$store
                ...
                .then(() => this.auction = this.$store.state.currentAuction);
        },
        mounted() {
        },
        methods: {
        ...
        computed: {
            getSeller() {
                this.$store.dispatch("getSellerName", this.$store.state.currentAuction.seller_id)
                    .then(() => this.sellerName = this.$store.state.currentSeller.firstname + " " + this.$store.state.currentSeller.lastname);
            ...
            getSellerName() {
                // return this.$store.dispatch("getSellerName", this.auction.seller_id);
            }
        }
    };
</script>
