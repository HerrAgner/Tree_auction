  ...
  <div class="v-content__wrap">
    ...
    <div class="container grid-list-xl">
     <div class="layout wrap" v-for="auction in this.pageContent">
        <AuctionListItem :title="auction.id" image="https://cdn.vuetifyjs.com/images/cards/desert.jpg"
         :endTime="auction.end_time" currBid=2500 :seller="auction.seller_id"></AuctionListItem>      </div>
    </div>
